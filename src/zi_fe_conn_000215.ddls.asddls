...
define view entity ZI_FE_CONN_000215
  as select from zfe_aconn_000215 as Connection
  association [1..1] to zi_fe_carr_000215 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
